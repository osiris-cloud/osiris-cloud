window.addEventListener('load', function () {
    const $accessKeyModal = $('#access-key-modal');
    const $keyName = $('#access-key-name');
    const $keyScopes = $('#key-scopes');
    const $subScopesTemplate = $('#sub-scopes');
    const $keyWrite = $('#access-key-write');
    const $keyExpiration = $('#key-expiration');
    const $keySubmitButton = $('#access-key-submit')
    const $keysTable = $('#keys-table');
    const $keysTableBody = $keysTable.find('tbody');

    const accessKeyModalEl = document.getElementById('access-key-modal');
    const options = {
        onHide: () => {
    ...
    const accessModal = new Modal(accessKeyModalEl, options, instanceOptions);
    ...
    $('#create-access-key').on('click', () => {
        accessModal.show();
    });

    $('#access-key-modal-close').click(() => {
        accessModal.hide();
    });
